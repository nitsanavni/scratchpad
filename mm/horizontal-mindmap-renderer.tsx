...
export function HorizontalMindmapRenderer({ nodes, selectedIndex = -1 }: HorizontalMindmapRendererProps) {
...
function HorizontalLineComponent({ line, selectedIndex, nodeTextToIndex }: HorizontalLineComponentProps) {
